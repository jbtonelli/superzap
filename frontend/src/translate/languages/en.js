const messages = {
	en: {
		translations: {
			...
			about: {
				title: "About SuperZap",
				abouttitle: "Origin and improvements",
				aboutdetail: "SuperZap is indirectly derived from the Whaticket project with improvements shared by the developers of the EquipeChat system through the VemFazer channel on YouTube, later improved by Claudemir Todo Bom",
				...
				licensedetail: "SuperZap is licensed under the GNU Affero General Public License version 3, which means that any user who has access to this application has the right to obtain access to the source code. More information at the links below:",
				licensefulltext: "Full text of the license",
				licensesourcecode: "SuperZap source code"
			},
			schedules: {
				title: "Schedules",
				confirmationModal: {
      ...
      ticketz: {
        support: {
          title: "Support SuperZap project",
