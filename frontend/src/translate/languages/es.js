const messages = {
  es: {
    translations: {
      ...
      about: {
        title: "Acerca de SuperZap",
        abouttitle: "Origen y Mejoras",
        aboutdetail: "SuperZap es derivado indirecto del proyecto Whaticket con mejoras compartidas por los desarrolladores del sistema EquipeChat a través del canal VemFazer en YouTube, posteriormente mejorado por Claudemir Todo Bom.",
        ...
        licensedetail: "SuperZap está licenciado bajo la Licencia Pública General Affero de GNU versión 3, lo que significa que cualquier usuario que tenga acceso a esta aplicación tiene derecho a obtener acceso al código fuente. Más información en los siguientes enlaces:",
        licensefulltext: "Texto completo de la licencia",
        licensesourcecode: "Código fuente de SuperZap"
      },
      schedules: {
        title: "Agendamentos",
        confirmationModal: {
      ...
      superzap: {
        support: {
          title: "Apoyar el proyecto SuperZap",
