const messages = {
  pt: {
    translations: {
      ...
      about: {
        title: "Sobre o SuperZap",
        abouttitle: "Origem e melhorias",
        aboutdetail: "SuperZap é derivado indireto do projeto Whaticket com melhorias compartilhadas pelos desenvolvedores do sistema EquipeChat através do canal VemFazer no youtube, posteriormente melhoradas por Claudemir Todo Bom",
        ...
        licensedetail: "SuperZap está licenciado sob a GNU Affero General Public License versão 3, isso significa que qualquer usuário que tiver acesso a esta aplicação tem o direito de obter acesso ao código fonte. Mais informações nos links abaixo:",
        licensefulltext: "Texto completo da licença",
        licensesourcecode: "Código fonte do SuperZap"
      },
      schedules: {
        title: "Agendamentos",
        confirmationModal: {
      ...
      ticketz: {
        support: {
          title: "Apoie o projeto SuperZap",
